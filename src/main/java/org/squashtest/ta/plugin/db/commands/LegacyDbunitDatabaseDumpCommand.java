...
/**
 * This is the legacy version with the ignored, bogus {@link FileResource} INPUT resource. see {@link DbunitDatabaseDumpCommand} for the new one based on {@link VoidResource}
...
public class LegacyDbunitDatabaseDumpCommand extends AbstractDbunitDatabaseDumpCommand implements Command<FileResource, DatabaseTarget> {
	...
	public void setResource(FileResource resource) {
		//TODO warning message when the "WITH" instruction would not be mandatory anymore.
	}
